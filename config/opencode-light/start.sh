...
console.log("opencode-light config ready; model: " + cfg.model + " | local: " + k("ollama-local") + " | cloud: " + k("ollama-cloud") + " | weave: " + k("weave") + " | prism: " + k("llama-prism") + " | webfetch: " + (cfg.permission.webfetch || "allow") + (process.env.OPENCODE_LOG_CHAT === "true" ? " | chat-logging: ON" : ""));
'
