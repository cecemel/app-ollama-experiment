"use strict";
// Logging proxy: opencode -> here -> Ollama (local or cloud). Logs the full chat
// request (messages + tools) and response (assistant text + tool calls) to stdout,
// so it shows up in `docker compose logs opencode`. Routes by /local or /cloud prefix.
